...
import { Evaluasi, SubKomponenLKE } from "@prisma/client";
...
interface EditProps {
    komponenId: string;
    evaluasi: Evaluasi;
    subKomponen: SubKomponenLKE;
  };

const SubKomponenEdit = ({
    komponenId, evaluasi, subKomponen
  }: EditProps) => {
    ...
    const onSubmit = async (values: z.infer<typeof formSchema>) => {
        try {
            ...
            toast.success("Sub komponen LKE diupdate!")
            form.reset()
            router.refresh()
        } catch {
    ...
    return (
        ...
        <Card className=" col-span-2">
            <Form {...form}>
                ...
                >
                    <CardHeader>
                        <CardTitle>Edit sub komponen</CardTitle>
                        <CardDescription>Edit sebuah sub komponen baru dalam satu kali klik.</CardDescription>
                    </CardHeader>
                    <CardContent>
...
export default SubKomponenEdit;