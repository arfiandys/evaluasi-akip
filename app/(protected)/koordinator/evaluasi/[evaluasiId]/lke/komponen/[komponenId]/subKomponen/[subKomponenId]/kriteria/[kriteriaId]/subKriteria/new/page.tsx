        ...
        <>
            <div className="p-6">
                    ...
                    <div className="flex flex-col gap-y-2 justify-between">
                        ...
                        <Breadcrumb>
                            <BreadcrumbList>
                                ...
                                <BreadcrumbSeparator />
                                <BreadcrumbItem>
                                    <BreadcrumbPage>Sub kriteria baru</BreadcrumbPage>
                                </BreadcrumbItem>
                            </BreadcrumbList>
                        </Breadcrumb>
                    </div>
                ...
                <div className="mt-16 grid gap-6 grid-cols-4">
                    <KriteriaNewCreate kriteria={kriteria!} evaluasi={evaluasi!} komponenId={params.komponenId} subKomponenId={params.subKomponenId} kriteriaId={params.kriteriaId} />
                </div>
            </div>
        </>
    );
