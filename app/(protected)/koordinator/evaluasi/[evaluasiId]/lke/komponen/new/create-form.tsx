...
interface KomponenNewProps {
    evaluasi: Evaluasi
}

const KomponenNewCreate = ({ evaluasi }: KomponenNewProps) => {
    ...
    const onSubmit = async (values: z.infer<typeof formSchema>) => {
        try {
            ...
            toast.success("Komponen LKE dibuat!")
            form.reset()
            router.refresh()
        } catch {
    ...
    return (
        ...
        <Card className=" col-span-2">
            <Form {...form}>
                ...
                >
                    <CardHeader>
                        <CardTitle>Buat komponen</CardTitle>
                        <CardDescription>Terapkan sebuah komponen baru dalam satu kali klik.</CardDescription>
                    </CardHeader>
                    <CardContent>
...
export default KomponenNewCreate;