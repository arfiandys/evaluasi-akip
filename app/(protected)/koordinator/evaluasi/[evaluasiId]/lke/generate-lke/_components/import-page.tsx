...
const ImportPage = ({ evaluasi }: ImportProps) => {
    ...
    const onSubmit = async (values: any[]) => {
        ...
        try {
            await axios.patch("/api/lke/generate-lke/import-panelisasi", value);
            toast.success("Hasil Panelisasi LKE berhasil diupload!")
            router.refresh()
        } catch {
        ...
        <>
            ...
            <Dialog>
                <DialogTrigger asChild>
                    <Button size='sm'>Import Panelisasi LKE</Button>
                </DialogTrigger>
                    ...
                    {(variant === VARIANTS.IMPORT) ? (
                        ...
                        <Card className="border-0 shadow-none w-full">
                            <CardHeader className="gap-y-2 lg:flex-row lg:items-center lg:justify-between">
                                <CardTitle>Import Panelisasi LKE</CardTitle>
