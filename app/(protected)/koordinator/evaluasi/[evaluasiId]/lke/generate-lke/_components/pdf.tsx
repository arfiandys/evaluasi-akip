...
import ReactPDF, { Page, Text, View, Document, StyleSheet, Image, Font, PDFViewer, PDFDownloadLink } from '@react-pdf/renderer';
    ...
    <Document>
        <Page style={styles.body}>
            ...
            <View style={styles.logo}>
                <Image
                    style={styles.imageKop}
                    src="/bps.png"
                />
                <Text style={styles.headerKop}>
...
// ReactPDF.renderToStream(<PDFButton />);