...
const ImportPage = ({ evaluasi, ikuId }: ImportProps) => {
    ...
    const onSubmit = async (values: any[]) => {
        ...
        const dataSorted = values.sort((a, b) => {
            const levelOrder: any = { "tujuan": 0, "sasaran": 1, "indikator": 2 };
            return levelOrder[a.jenis] - levelOrder[b.jenis];
        });
        const dataFiltered = dataSorted.filter((item) => {
            if ((item.jenis === "tujuan") || (item.jenis === "sasaran") || (item.jenis === "indikator")) {
                return item
            }
        })
        const value = {
        ...
        <>
            ...
            <Dialog>
                <DialogTrigger asChild>
                    <Button>Import tujuan/sasaran/indikator</Button>
                </DialogTrigger>
                    ...
                    {(variant === VARIANTS.IMPORT) ? (
                        ...
                        <Card className="border-0 shadow-none w-full">
                            <CardHeader className="gap-y-2 lg:flex-row lg:items-center lg:justify-between">
                                <CardTitle>Import tujuan/sasaran/indikator IKU</CardTitle>
