...
interface TSIEditProps {
    ikuId: string;
    evaluasiId: string;
    tujuanSasaranIndikator: TujuanSasaranIndikatorIKU
};

const TSIEdit = ({
    ikuId, evaluasiId, tujuanSasaranIndikator
}: TSIEditProps) => {
    ...
    const form = useForm<z.infer<typeof formSchema>>({
        ...
        defaultValues: {
            kode: tujuanSasaranIndikator.kode,
            nama: tujuanSasaranIndikator.nama,
            jenis: tujuanSasaranIndikator.jenis,
        },
    });
