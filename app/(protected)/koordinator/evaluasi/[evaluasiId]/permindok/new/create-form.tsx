...
const PermindokNewCreate = ({ evaluasi }: PermindokNewCreateProps) => {
    ...
    return (
        ...
        <Card className=" col-span-2">
            <Form {...form}>
                ...
                >
                    <CardHeader>
                        <CardTitle>Buat permindok</CardTitle>
                        <CardDescription>Terapkan sebuah permindok baru dalam satu kali klik.</CardDescription>
                    </CardHeader>
                    <CardContent>
...
export default PermindokNewCreate;