  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-[160px]">
        <Link href={`/koordinator/variabel-lke/komponen/${params.komponenId}/subKomponen/${kriteria.subKomponenLKEId}/kriteria/${kriteria.id}`}>
        ...
        <DropdownMenuSub>
          ...
          <DropdownMenuSubContent>
            <DropdownMenuRadioGroup value={kriteria.tahun}>
              {jenises.map((jenis) => (
