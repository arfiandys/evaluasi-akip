...
import { KomponenLKE, KriteriaLKE, SubKomponenLKE, Team } from "@prisma/client";
...
export const KodeForm = ({
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      await axios.patch(`/api/variabel-lke/komponen/${komponenId}/subKomponen/${subKomponenId}/kriteria/${kriteriaId}`, values);
      toast.success("Kriteria updated");
      toggleEdit();
      router.refresh();
    } catch {
