...
const CreateSubKomponenPage = ({
    ...
    const onSubmit = async (values: z.infer<typeof formSchema>) => {
        try {
            const response = await axios.post(`/api/variabel-lke/komponen/${komponenId}/subKomponen`, values);
...
export default CreateSubKomponenPage;